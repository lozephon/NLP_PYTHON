<Script Type="text/javascript">
    ...
    function addClause(num) {
        ...
        var str = tds[from].innerText + '~' + tds[to].innerText;
        ...
        newClause.innerHTML = "<input type=hidden name='clauseText"+num+"' value='"+str2+"'/><input type='text' size='250' onmouseout='highlightBack("+num+","+from+","+to+")' onmouseover='highlight("+num+","+from+","+to+")' name='clauseShow"+num+"' id='"+numClause+"'/><input type=button value='delete' onClick='deleteClause("+numClause+","+num+")'>";
